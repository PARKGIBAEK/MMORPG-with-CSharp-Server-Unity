...
class PacketManager
{
	...
	{		
		...
		_onRecv.Add((ushort)MsgId.SCreatePlayer=15;, MakePacket<S_CreatePlayer=15;>);
		_handler.Add((ushort)MsgId.SCreatePlayer=15;, PacketHandler.S_CreatePlayer=15;Handler);
	}
