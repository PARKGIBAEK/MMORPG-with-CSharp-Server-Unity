...
class PacketManager
{
	...
	{		
		...
		_onRecv.Add((ushort)MsgId.CCreatePlayer=14;, MakePacket<C_CreatePlayer=14;>);
		_handler.Add((ushort)MsgId.CCreatePlayer=14;, PacketHandler.C_CreatePlayer=14;Handler);
	}
